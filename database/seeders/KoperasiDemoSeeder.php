    ...
    public function run(): void
    {
        ...
        $members = [
            [
                ...
                'savings' => [
                    ['type' => 'pokok', 'amount' => 450000, 'transaction_date' => now()->subMonths(4)->toDateString(), 'note' => 'Setoran awal simpanan pokok'],
                    ['type' => 'wajib', 'amount' => 250000, 'transaction_date' => now()->subMonths(2)->toDateString(), 'note' => 'Setoran simpanan wajib'],
                ],
            ],
            [
                'member_no' => '24000002',
                ...
                'note' => 'Anggota demo koperasi mobile',
                'savings' => [
                    ['type' => 'pokok', 'amount' => 300000, 'transaction_date' => now()->subMonths(3)->toDateString(), 'note' => 'Setoran awal simpanan pokok'],
                    ['type' => 'sukarela', 'amount' => -100000, 'transaction_date' => now()->subMonth()->toDateString(), 'note' => 'Penarikan kas simpanan sukarela'],
                ],
            ],
        ];
